...
class S3fsCurl
{
  ...
  private:
    ...
    static std::string      CAM_role_url;
  ...
  public:
    ...
    static bool GetAccessKey(std::string &accessKey, std::string &secretKey);
    static bool GetAccessKeyWithToken(std::string &accessKey, std::string &secretKey, std::string &token);
    static bool SetAccessKeyWithToken(const std::string& accessKey, const std::string& secretKey, const std::string& token, const std::string& token_expired);
    ...
    static std::string SetCAMRoleUrl(const char *role_url);
